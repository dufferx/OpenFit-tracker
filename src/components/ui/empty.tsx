...
function Empty({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="empty" className={cn('flex min-w-0 flex-1 flex-col items-center justify-center gap-6 rounded-xl border border-dashed p-6 text-center md:p-10', className)} {...props} />
}
...
const emptyMediaVariants = cva('flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0', {
  variants: { variant: {
    ...
    icon: 'size-10 rounded-lg bg-muted text-foreground [&_svg]:size-5',
  } },
...
function EmptyTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="empty-title" className={cn('text-base font-medium', className)} {...props} />
}
...
function EmptyContent({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="empty-content" className={cn('flex w-full max-w-sm flex-col items-center gap-4 text-sm', className)} {...props} />
}
