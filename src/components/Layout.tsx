...
export function Layout() {
  ...
  return <div className="min-h-screen bg-background text-foreground">
    ...
    <Button variant="outline" size="icon" className="fixed right-4 top-4 z-30 bg-card/95 shadow-sm md:hidden" onClick={handleSignOut} disabled={isSigningOut} aria-label="Sign out"><LogOut aria-hidden="true" /></Button>
