...
export function SettingsPage() {
  ...
  if (profileQuery.isError) return <><PageHeader eyebrow="Preferences" title="Settings" /><QueryErrorAlert title="Unable to load settings" message={profileQuery.error.message} retry={() => void profileQuery.refetch()} /></>
